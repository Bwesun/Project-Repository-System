...
<article>
<hgroup>
  <span class="style2">Login Unsuccessful! Please Try Again!  </span>
  <h2>Admin Login </h2>
</hgroup>
<form action="achecklogin.php" method="post" enctype="multipart/form-data">
  <label>Username
  ...
  <center><input name="submit" type="submit" class="aa" value="Login"></center>
</form>
