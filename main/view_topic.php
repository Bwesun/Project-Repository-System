...
<br><br>
<a href="../files/<?php echo $rows['filename']; ?>" class="style7" style="background-color:#0099CC; border-radius:5px; padding-left:40px; padding-right:40px; padding-top:30px; padding-bottom:10px;">View Document</a> <!--
<center><a href="../files/<?php echo $rows['filename']; ?>" class="style7" style="background-color:#0099CC; border-radius:5px; padding-left:40px; padding-right:40px; padding-top:30px; padding-bottom:10px;"><img src="../img/dl.png" width="40" download><span class="style6">Download</span> </a>
</center> -->
</article>
</section>
<?php
...
<object data="../files/COM314.docx" type="application/msword"> Code Block</object>
<footer>
