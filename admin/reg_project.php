...
<fieldset>
<form action="reg_project_ac.php" method="post" enctype="multipart/form-data">
...
<input name="topic" type="text" required placeholder="Enter Project Topic">
</label></p>
<p><label>
...
<input name="year" type="text" required placeholder="Enter Project Year">
</label></p>
<p><label>Project Abstract
<textarea name="abstract" type="text" required placeholder="Enter Project Abstract"></textarea>
</label></p>
<p><label>Select File
